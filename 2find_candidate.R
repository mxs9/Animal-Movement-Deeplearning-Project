...
#change good_pair[c(?:?),]
good_pair_400=good_pair[c(390:400),]
...
write.csv(result_400,file="C:/workhard/Movement Seminar/MovementSeminar/Code_Mingxi/result_266.csv",row.names = FALSE,quote = FALSE)
